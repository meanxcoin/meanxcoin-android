package com.meanxcoin.core.coins.nxt;
...
//                + " existing key " + com.meanxcoin.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.meanxcoin.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.meanxcoin.core.coins.nxt.Crypto.rsDecode(com.meanxcoin.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.meanxcoin.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.meanxcoin.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.meanxcoin.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.meanxcoin.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.meanxcoin.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.meanxcoin.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
