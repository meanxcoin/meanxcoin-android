package com.meanxcoin.wallet;

import android.text.format.DateUtils;

import com.meanxcoin.core.coins.AsiacoinMain;
import com.meanxcoin.core.coins.AuroracoinMain;
import com.meanxcoin.core.coins.BatacoinMain;
import com.meanxcoin.core.coins.BitcoinMain;
import com.meanxcoin.core.coins.BitcoinTest;
import com.meanxcoin.core.coins.BlackcoinMain;
import com.meanxcoin.core.coins.BurstMain;
import com.meanxcoin.core.coins.CanadaeCoinMain;
import com.meanxcoin.core.coins.CannacoinMain;
import com.meanxcoin.core.coins.ClamsMain;
import com.meanxcoin.core.coins.ClubcoinMain;
import com.meanxcoin.core.coins.CoinID;
import com.meanxcoin.core.coins.CoinType;
import com.meanxcoin.core.coins.DashMain;
import com.meanxcoin.core.coins.DigibyteMain;
import com.meanxcoin.core.coins.DigitalcoinMain;
import com.meanxcoin.core.coins.DogecoinMain;
import com.meanxcoin.core.coins.DogecoinTest;
import com.meanxcoin.core.coins.EguldenMain;
import com.meanxcoin.core.coins.FeathercoinMain;
import com.meanxcoin.core.coins.GcrMain;
import com.meanxcoin.core.coins.GuldenMain;
import com.meanxcoin.core.coins.JumbucksMain;
import com.meanxcoin.core.coins.LitecoinMain;
import com.meanxcoin.core.coins.LitecoinTest;
import com.meanxcoin.core.coins.MonacoinMain;
import com.meanxcoin.core.coins.NamecoinMain;
import com.meanxcoin.core.coins.NeoscoinMain;
import com.meanxcoin.core.coins.NovacoinMain;
import com.meanxcoin.core.coins.NuBitsMain;
import com.meanxcoin.core.coins.NuSharesMain;
import com.meanxcoin.core.coins.NxtMain;
import com.meanxcoin.core.coins.OKCashMain;
import com.meanxcoin.core.coins.ParkbyteMain;
import com.meanxcoin.core.coins.PeercoinMain;
import com.meanxcoin.core.coins.PotcoinMain;
import com.meanxcoin.core.coins.ReddcoinMain;
import com.meanxcoin.core.coins.RubycoinMain;
import com.meanxcoin.core.coins.ShadowCashMain;
import com.meanxcoin.core.coins.UroMain;
import com.meanxcoin.core.coins.VergeMain;
import com.meanxcoin.core.coins.VertcoinMain;
import com.meanxcoin.core.coins.VpncoinMain;
import com.meanxcoin.core.coins.RichcoinMain;
import com.meanxcoin.core.coins.IxcoinMain;
import com.meanxcoin.core.coins.KhcoinMain;
import com.meanxcoin.core.coins.PopularcoinMain;
import com.meanxcoin.core.network.CoinAddress;
import com.meanxcoin.stratumj.ServerAddress;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/meanxcoin/meanxcoin-android/releases";

    public static final String VERSION_URL = "https://meanxcoin.com/version";
    public static final String SUPPORT_EMAIL = "support@meanxcoin.com";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(BitcoinMain.get(),      new ServerAddress("btc-cce-1.meanxcoin.net", 5001),
                                                    new ServerAddress("btc-cce-2.meanxcoin.net", 5001)),
            new CoinAddress(BitcoinTest.get(),      new ServerAddress("btc-testnet-cce-1.meanxcoin.net", 15001),
                                                    new ServerAddress("btc-testnet-cce-2.meanxcoin.net", 15001)),
            new CoinAddress(DogecoinMain.get(),     new ServerAddress("doge-cce-1.meanxcoin.net", 5003),
                                                    new ServerAddress("doge-cce-2.meanxcoin.net", 5003)),
            new CoinAddress(DogecoinTest.get(),     new ServerAddress("doge-testnet-cce-1.meanxcoin.net", 15003),
                                                    new ServerAddress("doge-testnet-cce-2.meanxcoin.net", 15003)),
            new CoinAddress(LitecoinMain.get(),     new ServerAddress("ltc-cce-1.meanxcoin.net", 5002),
                                                    new ServerAddress("ltc-cce-2.meanxcoin.net", 5002)),
            new CoinAddress(LitecoinTest.get(),     new ServerAddress("ltc-testnet-cce-1.meanxcoin.net", 15002),
                                                    new ServerAddress("ltc-testnet-cce-2.meanxcoin.net", 15002)),
            new CoinAddress(PeercoinMain.get(),     new ServerAddress("ppc-cce-1.meanxcoin.net", 5004),
                                                    new ServerAddress("ppc-cce-2.meanxcoin.net", 5004)),
            new CoinAddress(NuSharesMain.get(),     new ServerAddress("nsr-cce-1.meanxcoin.net", 5011),
                                                    new ServerAddress("nsr-cce-2.meanxcoin.net", 5011)),
            new CoinAddress(NuBitsMain.get(),       new ServerAddress("nbt-cce-1.meanxcoin.net", 5012),
                                                    new ServerAddress("nbt-cce-2.meanxcoin.net", 5012)),
            new CoinAddress(DashMain.get(),         new ServerAddress("drk-cce-1.meanxcoin.net", 5013),
                                                    new ServerAddress("drk-cce-2.meanxcoin.net", 5013)),
            new CoinAddress(ReddcoinMain.get(),     new ServerAddress("rdd-cce-1.meanxcoin.net", 5014),
                                                    new ServerAddress("rdd-cce-2.meanxcoin.net", 5014)),
            new CoinAddress(BlackcoinMain.get(),    new ServerAddress("blk-cce-1.meanxcoin.net", 5015),
                                                    new ServerAddress("blk-cce-2.meanxcoin.net", 5015)),
            new CoinAddress(NamecoinMain.get(),     new ServerAddress("nmc-cce-1.meanxcoin.net", 5016),
                                                    new ServerAddress("nmc-cce-2.meanxcoin.net", 5016)),
            new CoinAddress(FeathercoinMain.get(),  new ServerAddress("ftc-cce-1.meanxcoin.net", 5017),
                                                    new ServerAddress("ftc-cce-2.meanxcoin.net", 5017)),
            new CoinAddress(RubycoinMain.get(),     new ServerAddress("rby-cce-1.meanxcoin.net", 5018),
                                                    new ServerAddress("rby-cce-2.meanxcoin.net", 5018)),
            new CoinAddress(UroMain.get(),          new ServerAddress("uro-cce-1.meanxcoin.net", 5019),
                                                    new ServerAddress("uro-cce-2.meanxcoin.net", 5019)),
            new CoinAddress(DigitalcoinMain.get(),  new ServerAddress("dgc-cce-1.meanxcoin.net", 5020),
                                                    new ServerAddress("dgc-cce-2.meanxcoin.net", 5020)),
            new CoinAddress(CannacoinMain.get(),    new ServerAddress("ccn-cce-1.meanxcoin.net", 5021),
                                                    new ServerAddress("ccn-cce-2.meanxcoin.net", 5021)),
            new CoinAddress(MonacoinMain.get(),     new ServerAddress("mona-cce-1.meanxcoin.net", 5022),
                                                    new ServerAddress("mona-cce-2.meanxcoin.net", 5022)),
            new CoinAddress(DigibyteMain.get(),     new ServerAddress("dgb-cce-1.meanxcoin.net", 5023),
                                                    new ServerAddress("dgb-cce-2.meanxcoin.net", 5023)),
            // 5024 primecoin
            new CoinAddress(ClamsMain.get(),        new ServerAddress("clam-cce-1.meanxcoin.net", 5025),
                                                    new ServerAddress("clam-cce-2.meanxcoin.net", 5025)),
            new CoinAddress(ShadowCashMain.get(),   new ServerAddress("sdc-cce-1.meanxcoin.net", 5026),
                                                    new ServerAddress("sdc-cce-2.meanxcoin.net", 5026)),
            new CoinAddress(NeoscoinMain.get(),     new ServerAddress("neos-cce-1.meanxcoin.net", 5027),
                                                    new ServerAddress("neos-cce-2.meanxcoin.net", 5027)),
            new CoinAddress(VertcoinMain.get(),     new ServerAddress("vtc-cce-1.meanxcoin.net", 5028),
                                                    new ServerAddress("vtc-cce-2.meanxcoin.net", 5028)),
            new CoinAddress(JumbucksMain.get(),     new ServerAddress("jbs-cce-1.meanxcoin.net", 5029),
                                                    new ServerAddress("jbs-cce-2.meanxcoin.net", 5029)),
            new CoinAddress(VpncoinMain.get(),      new ServerAddress("vpn-cce-1.meanxcoin.net", 5032),
                                                    new ServerAddress("vpn-cce-2.meanxcoin.net", 5032)),
            new CoinAddress(CanadaeCoinMain.get(),  new ServerAddress("cdn-cce-1.meanxcoin.net", 5033),
                                                    new ServerAddress("cdn-cce-2.meanxcoin.net", 5033)),
            new CoinAddress(NovacoinMain.get(),     new ServerAddress("nvc-cce-1.meanxcoin.net", 5034),
                                                    new ServerAddress("nvc-cce-2.meanxcoin.net", 5034)),
            new CoinAddress(ParkbyteMain.get(),     new ServerAddress("pkb-cce-1.meanxcoin.net", 5035),
                                                    new ServerAddress("pkb-cce-2.meanxcoin.net", 5035)),
            new CoinAddress(NxtMain.get(),          new ServerAddress("176.9.65.41", 7876),
                    new ServerAddress("176.9.65.41", 7876)),
            new CoinAddress(BurstMain.get(),        new ServerAddress("burst-cce-1.meanxcoin.net", 5051),
                                                    new ServerAddress("burst-cce-2.meanxcoin.net", 5051)),
            new CoinAddress(VergeMain.get(),        new ServerAddress("xvg-cce-1.meanxcoin.net", 5036),
                                                    new ServerAddress("xvg-cce-2.meanxcoin.net", 5036)),
            new CoinAddress(EguldenMain.get(),      new ServerAddress("efl-cce-1.meanxcoin.net", 5037),
                                                    new ServerAddress("efl-cce-2.meanxcoin.net", 5037)),
            new CoinAddress(GcrMain.get(),          new ServerAddress("gcr-cce-1.meanxcoin.net", 5038),
                                                    new ServerAddress("gcr-cce-2.meanxcoin.net", 5038)),
            new CoinAddress(PotcoinMain.get(),      new ServerAddress("pot-cce-1.meanxcoin.net", 5039),
                                                    new ServerAddress("pot-cce-2.meanxcoin.net", 5039)),
            new CoinAddress(GuldenMain.get(),       new ServerAddress("gulden-cce-1.meanxcoin.net", 5040),
                                                    new ServerAddress("gulden-cce-2.meanxcoin.net", 5040)),
            new CoinAddress(AuroracoinMain.get(),   new ServerAddress("aur-cce-1.meanxcoin.net", 5041),
                                                    new ServerAddress("aur-cce-2.meanxcoin.net", 5041)),
            new CoinAddress(BatacoinMain.get(),     new ServerAddress("bata-cce-1.meanxcoin.net", 5042),
                                                    new ServerAddress("bata-cce-1.meanxcoin.net", 5042)),
            new CoinAddress(OKCashMain.get(),       new ServerAddress("ok-cce-1.meanxcoin.net", 5043),
                                                    new ServerAddress("ok-cce-2.meanxcoin.net", 5043)),
            new CoinAddress(AsiacoinMain.get(),     new ServerAddress("ac-cce-1.meanxcoin.net", 5044),
                                                    new ServerAddress("ac-cce-2.meanxcoin.net", 5044)),
            new CoinAddress(ClubcoinMain.get(),     new ServerAddress("club-cce-1.meanxcoin.net", 5045),
                                                    new ServerAddress("club-cce-2.meanxcoin.net", 5045)),
            new CoinAddress(RichcoinMain.get(),     new ServerAddress("richx-cce-1.meanxcoin.net", 5046),
                                                    new ServerAddress("richx-cce-2.meanxcoin.net", 5046)),
            ...
            new CoinAddress(IxcoinMain.get(),       new ServerAddress("ixc-cce-1.meanxcoin.net", 5047),
                                                    new ServerAddress("ixc-cce-2.meanxcoin.net", 5047))
    );
