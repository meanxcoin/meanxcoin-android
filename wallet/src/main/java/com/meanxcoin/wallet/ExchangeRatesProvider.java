...
import com.meanxcoin.core.coins.FiatValue;
import com.meanxcoin.core.coins.Value;
import com.meanxcoin.core.util.ExchangeRateBase;
...
public class ExchangeRatesProvider extends ContentProvider {
    ...
    private static final String BASE_URL = "https://ticker.meanxcoin.net/simple";
    ...
    private static final String meanxcoin_SOURCE = "meanxcoin.com";
                ...
                if (!"extras".equals(toSymbol)) {
                    ...
                    if (rateStr != null) {
                        try {
                            ...
                            rates.put(toSymbol, new ExchangeRate(rate, toSymbol, meanxcoin_SOURCE));
